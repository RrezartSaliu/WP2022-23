...
@WebServlet(name = "select", urlPatterns = "/selectBalloon")
public class SelectBalloonServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        webContext.setVariable("balloonType",req.getParameter("color"));
        req.getSession().setAttribute("balloonType", req.getParameter("color"));
        System.out.println(req.getSession().getAttribute("balloonType"));
